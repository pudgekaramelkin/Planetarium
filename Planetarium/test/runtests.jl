...
# !!! Main.UserApp is configured as an alias for Main.Planetarium and you might encounter it in some tests
using Main.Planetarium, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Planetarium tests" begin
  @includetests ARGS
end
